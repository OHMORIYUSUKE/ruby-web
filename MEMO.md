...
```sh
curl -X POST -H "Content-Type: application/json" -d '{"code": "user_input = gets.chomp; output_message = user_input + \" Ruby !\"; puts output_message", "input": "Hello"}' http://localhost:3000/api/ruby/execute
```
